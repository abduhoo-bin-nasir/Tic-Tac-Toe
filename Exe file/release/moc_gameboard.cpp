...
#include "../../TicTacToe_Game/gameboard.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameBoardENDCLASS_t qt_meta_stringdata_CLASSGameBoardENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 14),  // "backToMainMenu"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 13),  // "onCellClicked"
        QT_MOC_LITERAL(40, 14),  // "onResetClicked"
        QT_MOC_LITERAL(55, 17)   // "onMainMenuClicked"
    },
    "GameBoard",
    "backToMainMenu",
    "",
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameBoard::backToMainMenu; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
